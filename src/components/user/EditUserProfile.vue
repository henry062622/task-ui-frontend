<template>
  ...
  <a-form :model="formState" name="update_user" layout="vertical" autocomplete="off" @finish="onSubmit" class="w-full"
    ...
    <a-row>
      <a-col :span="24">
        <a-form-item :label="$t('name')" name="name" :rules="[{ required: true, message: 'please input User name!' }]"
    ...
    <a-row>
      <a-col span="24">
        <a-form-item :label="$t('email')" name="email"
          ...
          <a-input v-model:value="formState.email" class="w-full md:!w-1/2"> </a-input>
        </a-form-item>
      </a-col>
    </a-row>
    ...
    <a-row>
      <a-col span="24">
        <a-form-item :label="$t('role')" name="role">
          <a-input :value="user.role.name" class="w-full md:!w-1/2" disabled> </a-input>
        </a-form-item>
      </a-col>
    </a-row>
